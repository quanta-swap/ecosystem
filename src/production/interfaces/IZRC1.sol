...
interface IZRC1 {
    ...
    error InsufficientBalance(address from, uint64 want, uint64 have);

    /// Allowance too low for the requested transfer-from.
    error InsufficientAllowance(address owner, uint64 want, uint64 have);
